...
export const projectsIntro = {
    ...
    "en": "Below are some of my projects that I have worked on either in my spare time, studies or as a freelancer. Among these are websites that can be visited via the corresponding domain, as well as others that are available via NPM or GitHub. Other projects that are not listed here can be found on my GitHub account."
