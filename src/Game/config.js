...
const translation = {
    de: {
        ...
        "back": "Zurück",
        "name": "Arcade-Modus",
        "explaination": "Beende Level um einzelne Seiten freizuschalten. Erreiche mit deiner Spielfigur den Pokal, um ein Level anzuschließen.",
        "controlls": "Bewegung",
        "arrow": "Pfeiltasten",
        "jump": "Springen",
        "space": "Leertaste",
    ...
    en: {
        ...
        "name": "Arcade-Mode",
        "explaination": "Finish Level to unlock single pages. Reach the cup to finish a level.",
        "controlls": "Controlls",
        "arrow": "Arrow keys",
        "jump": "Jump",
        "space": "Space",
