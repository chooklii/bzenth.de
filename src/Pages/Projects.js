      ...
      <div key={keyGenerator()} className="design_buttons">
        {single.primaryLink && (
          <Button
            ...
            type="primary"
            onClick={() => window.open(single.primaryLink, "_blank")}
          >
        ...
        {single.secondaryLink && (
          <Button
            ...
            className="button_public_project"
            type="normal"
            onClick={() => window.open(single.secondaryLink, "_blank")}
          >
    ...
    return (
      ...
      >
        ...
        <div className="project_classic">
          ...
          {single.image && (
            <img
              src={single.image.fields.file.url}
              alt={single.image.fields.description}
  ...
  return (
    <div>
      ...
      <div className="projects-box page_classic">
        <p className="classic_text marginLeftRight">
          {projectsIntro[language]}
        </p>
        <Row>{renderData()}</Row>
      </div>
      {!props.game && <Footer />}
